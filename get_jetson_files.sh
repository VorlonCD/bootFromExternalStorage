...
# Get the R34.1.1 Tegra system
# Get the L4T Driver Package - BSP
wget -N https://developer.nvidia.com/embedded/l4t/r34_release_v1.1/release/jetson_linux_r34.1.1_aarch64.tbz2
# Get the Sample Root File System (rootfs)
wget -N https://developer.nvidia.com/embedded/l4t/r34_release_v1.1/release/tegra_linux_sample-root-filesystem_r34.1.1_aarch64.tbz2
...
# wget -N https://developer.nvidia.com/embedded/l4t/r34_release_v1.1/secureboot_r34.1.1_aarch64.tbz2


# Unpack the files, creating the Linux_for_Tegra folder
sudo tar xpvf jetson_linux_r34.1.1_aarch64.tbz2
cd Linux_for_Tegra/rootfs/
sudo tar xpvf ../../tegra_linux_sample-root-filesystem_r34.1.1_aarch64.tbz2
cd ../..
tar xvjf secureboot_r34.1.1_aarch64.tbz2
cd Linux_for_Tegra/
